...
//	            f_read(&MyFile, rtext, sizeof(rtext) - 1, &bytesread);
//	            printf("F read success!");
//	            // Close the file
//	            f_close(&MyFile);
//	            printf("F read close success!");
//	        }
//
//	        // Delete the file
//	        //f_unlink("0:STM32.TXT");
//	    }
//	    else
//	    {
